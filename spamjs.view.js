define("spamjs.view").as(function(view) {
    ...
    var extend = function(model){
        return jQuery.extend(this,model);
    };
    ...
    return {
        ...
        model: function(model) {
            if (model !== undefined) {
                ...
                this._apply_();
                if(!this.__model__.extend){
                    this.__model__.extend = extend;
                }
            }
        ...
        trigger: function(eventName, detail) {
            ...
            if (this.customEvents) {
                return _eventName = this.customEvents[_eventName];
            }
            return  pitana.domEvents.trigger(this.$$[0], _eventName, detail);
        },
        _remove_: function() {
        },
        _ready_: function() {
